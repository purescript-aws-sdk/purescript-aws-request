...
foreign import requestImpl :: forall eff. Foreign -> String -> Foreign -> EffectFnAff Foreign
request :: forall eff i o. Encode i => Decode o => Service -> MethodName -> i -> Aff o
